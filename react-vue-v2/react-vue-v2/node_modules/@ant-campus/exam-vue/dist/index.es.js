import { defineComponent, reactive, onMounted, watch, createVNode, computed, createTextVNode, isVNode, cloneVNode, mergeProps } from "vue";
...
const Markdown = defineComponent({
  ...
  setup({
    ...
    onMounted(() => {
      if (text) {
        state.markdownHTML = marked(text);
      }
    });
    watch(() => text, (text2, old) => {
      if (text2 !== old) {
        state.markdownHTML = marked(text2.trim());
      }
    });
    return () => {
      var _a, _b, _c;
      ...
      }, [(_a = slots.before) == null ? void 0 : _a.call(slots), createVNode("article", {
        "innerHTML": state.markdownHTML
      }, null), (_b = slots.default) == null ? void 0 : _b.call(slots), (_c = slots.after) == null ? void 0 : _c.call(slots)]);
    };
  }
});
const Exam = defineComponent({
  props: {
    title: String,
    description: String,
    render: Function,
  ...
  `);
    ...
    const renderResult = () => {
      ...
      if (render) {
        ...
        return createVNode("strong", null, [createTextVNode("\u8FD0\u884C\u4E2D")]);
    ...
    return () => createVNode("div", null, [createVNode(Markdown, {
      "text": text.value
    }, {
      default: () => {
        var _a;
        ...
        }, [(_a = slots.render) == null ? void 0 : _a.call(slots), renderResult()])];
      }
    })]);
  }
});
const Paper = defineComponent({
  ...
  setup({
    ...
    return () => createVNode("div", null, [exams.map((exam, index) => {
      if (isVNode(exam)) {
        return cloneVNode(exam, {
          key: "v-exam-" + index
        });
      }
      return createVNode(Exam, mergeProps({
        "key": index
      }, exam), null);
    })]);
  }
});
export { Exam, Markdown, Paper };
