...
import {
	...
	Paper as ReactPaper,
} from '@ant-campus/exam-react'
import {
	Markdown as VueMarkdown,
	Paper as VuePaper,
} from '@ant-campus/exam-vue'
...
const AppVue = defineComponent(() => {
	return () => {
		return h('div', {}, [
			h(VueMarkdown, { text: headline }),
			h(VuePaper, { exams: vueExams }),
		])
	}
})
